...
//	}
	...
	public void test29(){
		...
		HashMap<String, String> map = new HashMap<String, String>();
		map.put("codeStr", "399006.SZ,000001.SS");
		System.out.println(doPost(url, map));
	}
...
//	}
	...
	public void test1117(){
		...
		HashMap<String, String> map = new HashMap<String, String>();
		map.put("userid","81");
		map.put("token", "CA33792B4D43424B8DA8586D872A12AE2017081509363536925CA9");
		System.out.println(doPost(url, map));
	}

	@Test
	public void test118(){
		String url=host+"incomeLoss/getIncomeLoss2.do";
		HashMap<String, String> map = new HashMap<String, String>();
		map.put("userid", "42557");
		map.put("token", "3FE847F2FB2748DA8A76B01B59FFBAC42017092914384336925CA9");
		System.out.println(doPost(url, map));
	}
	@Test
	public void test001(){
	...
	//	{"msg":"操作成功","data":[{"id":1394,"userid":42557,"stockid":"000001","stockcode":"000001.SZ","name":"平安银行","bspoint":1,"time":"2017/08/11 18:11:22","type":"1","status":0},{"id":1452,"userid":42557,"stockid":"000002","stockcode":"000002.SZ","name":"万  科Ａ","bspoint":1,"time":"2017/08/11 18:11:22","type":"1","status":0}],"status":0}
		...
		//优化组合未读
				...
				public void test151(){
					String url=host+"incomeLoss/revenue.do";
					HashMap<String, String> map = new HashMap<String, String>();
					map.put("Ef", "-0.0006");//期货
					map.put("Ed", "0.00035");//债券
					map.put("Es", "-0.0299");//股票
					map.put("Ec", "0");//现金
					map.put("sharesmoney", "1990132.59");
					map.put("futuresmoney", "1857355.72");
					System.out.println(doPost(url, map));
				}
				...
				@Test
				public void test154(){
					String url=host+"FuturesShares/getSharesPosition.do";
					HashMap<String, String> map = new HashMap<String, String>();
					System.out.println(doPost(url, map));
				}
				...
				@Test
				public void test155(){
					String url=host+"FuturesTraderec/getFuturesPosition.do";
					HashMap<String, String> map = new HashMap<String, String>();
					System.out.println(doPost(url, map));
				}
